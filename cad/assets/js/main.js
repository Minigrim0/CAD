...
function checkCoordinates() {
  ...
  if (!phone)
    document.getElementById("notGoodPhone").innerHTML =
      "Ce numero de telephone n'est pas correct";
  if (!address)
    document.getElementById("notGoodAddress").innerHTML =
      "Ce champ est obligatoire!";
  if (!mail)
    document.getElementById("mailError").innerHTML =
      "Cette adresse mail n'est pas correcte!";
  if (!courses)
    document.getElementById("notGoodCourse").innerHTML =
      "Vous devez choisir au moins un cours!";
  if (!birth)
    document.getElementById("notGoodBirth").innerHTML =
      "Cette date de naissance n'a pas le bon format!";

  return phone && birth && address && courses;
}
...
function checkC_Coordinates() {
  ...
  courses =
    document.getElementById("C_math").checked ||
  ...
  if (!mail)
    document.getElementById("C_mailError").innerHTML =
      "Cette addresse mail n'est pas correcte!";
  if (!iban)
    document.getElementById("C_notGoodIBAN").innerHTML =
      "Ce champ est obligatoire!";
  if (!natreg_number)
  ...
  return phone && address && iban && natreg_number && courses && school;
}
...
function checkC_Names() {
  ...
  if (!lastName) {
    document.getElementById("C_notGoodLastName").innerHTML =
      "Ce champ est obligatoire!";
  }
  if (!firstName) {
    document.getElementById("C_notGoodFirstName").innerHTML =
      "Ce champ est obligatoire!";
  }
