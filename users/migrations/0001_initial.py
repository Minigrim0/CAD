    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "French_level",
                    models.CharField(
                        blank=True, default="Inconnu", max_length=50, null=True
                    ),
                ),
                (
                    "English_level",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "Maths_course",
                    models.BooleanField(default=False, verbose_name="Maths"),
                ),
                (
                    "Chimie_course",
                    models.BooleanField(default=False, verbose_name="Chimie"),
                ),
                (
                    "Physique_course",
                    models.BooleanField(default=False, verbose_name="Physique"),
                ),
                (
                    "Francais_course",
                    models.BooleanField(default=False, verbose_name="Francais"),
                ),
                (
                    "secret_key",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "wanted_schedule",
                    models.TextField(
                        blank=True, default="", null=True, verbose_name="Horaire"
                    ),
                ),
                (
                    "unsub_proposal",
                    models.BooleanField(
                        default=False,
                        verbose_name="Proposition de désinscription envoyée",
                    ),
                ),
                (
                    "confirmedAccount",
                    models.BooleanField(
                        default=False,
                        verbose_name="A payé ses 2 premières heures de cours",
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="users.studentRequest"
            ),
        ),
        migrations.AddField(
