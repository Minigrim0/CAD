...
urlpatterns = [
    ...
    url(r'articles/modify/',
        administration.views.articleAdminModify, name="modifyArticle"),
    url(r'articles/',
        administration.views.articleAdminView, name="articles_admin"),
    url(r'mails/modify/', administration.views.mailAdminModify, name="modifyMail"),
